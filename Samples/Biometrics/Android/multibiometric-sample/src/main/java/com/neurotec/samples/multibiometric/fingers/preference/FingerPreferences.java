...
public final class FingerPreferences extends PreferenceActivity {
	...
	public static final String RETURN_PROCESSED_IMAGE = "finger_return_processed_image";
	...
	public static void updateClient(NBiometricClient client, Context context) {
		...
		client.setFingersReturnProcessedImage(preferences.getBoolean(RETURN_PROCESSED_IMAGE, false));
	}
	...
	public static boolean isReturnProcessedImage(Context context) {
		SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
		return preferences.getBoolean(RETURN_PROCESSED_IMAGE, false);
	}
	...
	private class FingerPreferencesFragment extends BasePreferenceFragment {
